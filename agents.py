...
class SarsaAgent:
    ...
    def update(self, state, action, reward, next_state, next_action):
        ...
        # YOUR CODE HERE
        current_value = self.Q_est[state][action]
        next_value = self.Q_est[next_state][next_action]

        update_value = reward + self.gamma * next_value - current_value
        self.Q_est[state][action] += self.alpha * update_value
...
class QLearningAgent:
    ...
    def update(self, state, action, reward, next_state):
        ...
        # YOUR CODE HERE
        current_value = self.Q_est[state][action]
        max_next_value = np.max(self.Q_est[next_state])

        update_value = reward + self.gamma * max_next_value - current_value
        self.Q_est[state][action] += self.alpha * update_value
